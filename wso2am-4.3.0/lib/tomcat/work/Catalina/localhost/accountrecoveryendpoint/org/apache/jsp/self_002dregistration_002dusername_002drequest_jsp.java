 ...
 * Generated at: 2024-07-09 09:36:15 UTC
...
public final class self_002dregistration_002dusername_002drequest_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  if (!StringUtils.isEmpty(cssPath)) {
      ...
      try {
        ...
        // /self-registration-username-request.jsp(134,5) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /self-registration-username-request.jsp(134,5) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /self-registration-username-request.jsp(134,5) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /self-registration-username-request.jsp(135,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if ("API Manager".equals(request.getAttribute("headerTitle"))) { 
    ...
    if (!StringUtils.isEmpty(logoSrc)) {
            ...
            try {
              ...
              // /self-registration-username-request.jsp(146,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if (!isCallBackUrlEmpty) { 
                  out.write("\n");
                  out.write("                            <a id=\"goBack\"\n");
                  out.write("                               href='");
                  out.print(Encode.forHtmlAttribute(request.getParameter("callback")));
                  out.write("'\n");
            ...
            try {
              ...
              // /self-registration-username-request.jsp(236,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
