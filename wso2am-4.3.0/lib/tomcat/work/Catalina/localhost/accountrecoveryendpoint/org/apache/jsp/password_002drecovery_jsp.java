 ...
 * Generated at: 2024-07-09 09:36:14 UTC
...
public final class password_002drecovery_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/includes/product-footer.jsp", Long.valueOf(1712515040000L));
    ...
    _jspx_dependants.put("/includes/footer.jsp", Long.valueOf(1709439816000L));
    ...
    _jspx_dependants.put("/includes/product-title.jsp", Long.valueOf(1712515040000L));
    _jspx_dependants.put("/includes/header.jsp", Long.valueOf(1712515040000L));
  ...
  if (!StringUtils.isEmpty(cssPath)) {
      ...
      try {
        ...
        // /password-recovery.jsp(132,4) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /password-recovery.jsp(132,4) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /password-recovery.jsp(132,4) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /password-recovery.jsp(133,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if ("API Manager".equals(request.getAttribute("headerTitle"))) { 
                  ...
                  out.write("    <div class=\"theme-icon inline auto transparent product-logo\" style=\"margin: 0;\">\n");
    ...
    if (!StringUtils.isEmpty(logoSrc)) {
            ...
            try {
              ...
              // /password-recovery.jsp(144,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if (error) { 
                  ...
                  out.write("                                ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, enterUsernameHereText));
                  out.write("\n");
                  out.write("                            </label>\n");
                  out.write("                            <input id=\"username\" name=\"username\" value=\"");
                  out.print(Encode.forHtmlAttribute(username));
                  out.write("\" type=\"text\" tabindex=\"0\" required>\n");
                  out.write("                            ");

                                if (!IdentityTenantUtil.isTenantQualifiedUrlsEnabled()) {
                            
                  out.write("\n");
                  out.write("                            <input id=\"tenantDomain\" name=\"tenantDomain\" value=\"");
                  ...
                  out.write("\n");
                  out.write("                            </label>\n");
                  out.write("                            <input id=\"username\" name=\"username\" type=\"text\" tabindex=\"0\" required>\n");
                  out.write("                            ");
                  ...
                  out.write("                                data-action=\"passwordRecovery\"\n");
            ...
            try {
              ...
              // /password-recovery.jsp(277,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("                const firstName = $(\"#username\").val();\n");
