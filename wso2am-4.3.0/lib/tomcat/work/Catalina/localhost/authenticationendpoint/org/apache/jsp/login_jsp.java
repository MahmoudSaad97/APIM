 ...
 * Generated at: 2024-07-09 09:36:49 UTC
...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/basicauth.jsp", Long.valueOf(1712515040000L));
    _jspx_dependants.put("/includes/init-url.jsp", Long.valueOf(1709439816000L));
    _jspx_dependants.put("/openid.jsp", Long.valueOf(1709439816000L));
    _jspx_dependants.put("/includes/init-loginform-action-url.jsp", Long.valueOf(1709439816000L));
    _jspx_dependants.put("/includes/localize.jsp", Long.valueOf(1709439816000L));
    _jspx_dependants.put("/identifierauth.jsp", Long.valueOf(1712515040000L));
    _jspx_dependants.put("/WEB-INF/lib/org.wso2.identity.apps.taglibs.layout.controller-1.4.34.jar", Long.valueOf(1709439648000L));
    _jspx_dependants.put("/tenantauth.jsp", Long.valueOf(1709439816000L));
    _jspx_dependants.put("/plugins/basicauth-extensions.jsp", Long.valueOf(1709439816000L));
  ...
  static {
    ...
    _jspx_imports_classes.add("static org.wso2.carbon.CarbonConstants.HOST_NAME_VERIFIER");
    _jspx_imports_classes.add("org.apache.http.conn.ssl.AllowAllHostnameVerifier");
    ...
    _jspx_imports_classes.add("static org.wso2.carbon.CarbonConstants.ALLOW_ALL");
    ...
    _jspx_imports_classes.add("org.apache.cxf.transport.http.HTTPConduit");
    ...
    _jspx_imports_classes.add("static org.wso2.carbon.CarbonConstants.DEFAULT_AND_LOCALHOST");
    ...
    _jspx_imports_classes.add("org.wso2.carbon.utils.CustomHostNameVerifier");
    ...
    _jspx_imports_classes.add("org.apache.cxf.configuration.jsse.TLSClientParameters");
    ...
    _jspx_imports_classes.add("org.apache.cxf.jaxrs.client.Client");
 ...
 if (new File(getServletContext().getRealPath("extensions/timeout.jsp")).exists()) { 
      ...
      try {
        ...
        // /login.jsp(212,4) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /login.jsp(212,4) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /login.jsp(212,4) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /login.jsp(213,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if (isSelfSignUpEPAvailable && !isIdentifierFirstLogin(inputType)) { 
    ...
    if (proxyContextPath == null) {
        proxyContextPath = "";
                  ...
                  out.write("\"\n");
                  out.write("                        let loginRequestPath = \"");
                  out.print(loginContextRequestUrl);
                  out.write("\"\n");
                  ...
                  out.write("                            loginRequestPath = loginRequestPath.startsWith('../') ? loginRequestPath.substring(2, loginRequestPath.length) : loginRequestPath\n");
                  out.write("                        }\n");
                  out.write("                        $.ajax({\n");
                  out.write("                            type: \"GET\",\n");
                  out.write("                            url: contextPath + loginRequestPath,\n");
                  out.write("                            xhrFields: { withCredentials: true },\n");
                  out.write("                            success: function (data) {\n");
                  out.write("                                if (data && data.status == 'redirect' && data.redirectUrl && data.redirectUrl.length > 0) {\n");
                  out.write("                                    window.location.href = data.redirectUrl;\n");
...
if (idpAuthenticatorMapping != null &&
 ...
 if (isHubIdp) { 
                  ...
                  out.write("\"\n");
                  out.write("                                            >\n");
                  out.write("                                                <img role=\"presentation\" class=\"ui image\" src=\"");
                  ...
                  out.write("',\n");
                  out.write("                                        'IwaNTLMAuthenticator')\"\n");
                  out.write("                                    id=\"icon-");
                  out.print(iconId);
                  out.write("\"\n");
                  out.write("                                    title=\"");
                  ...
                  out.write("                                    <img role=\"presentation\" src=\"libs/themes/default/assets/images/icons/fingerprint.svg\" alt=\"Fido Logo\" />\n");
                  out.write("                                    <span>\n");
                  out.write("                                        ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "sign.in.with" ));
                  out.write("\n");
                  ...
                  out.write("                                        <img role=\"presentation\" class=\"ui image\" src=\"libs/themes/default/assets/images/icons/magic-link-icon.svg\" alt=\"Magic Link Logo\" />\n");
                  out.write("                                        <span>\n");
                  out.write("                                            ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "sign.in.with" ));
                  out.write("\n");
            ...
            try {
              ...
              // /login.jsp(452,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.print(loginContextRequestUrl);
      out.write("\"\n");
      out.write("            if (proxyPath !== \"\") {\n");
      out.write("                loginRequestPath = loginRequestPath.startsWith('../') ? loginRequestPath.substring(2, loginRequestPath.length) : loginRequestPath\n");
      out.write("            }\n");
      out.write("            $.ajax({\n");
      out.write("                type: \"GET\",\n");
      out.write("                url: proxyPath + loginRequestPath,\n");
      out.write("                xhrFields: { withCredentials: true },\n");
      out.write("                success: function (data) {\n");
      out.write("                    if (data && data.status == 'redirect' && data.redirectUrl && data.redirectUrl.length > 0) {\n");
      out.write("                        window.location.href = data.redirectUrl;\n");
