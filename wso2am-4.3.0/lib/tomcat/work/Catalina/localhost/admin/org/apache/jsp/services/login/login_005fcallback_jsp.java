 ...
 * Generated at: 2024-07-09 09:36:20 UTC
...
public final class login_005fcallback_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/services/login/../constants.jsp", Long.valueOf(1712475548000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (error != null && error.equals("login_required")) {
        ...
        if (tokenResponse.get("error") != null) {
            ...
            cookie.setPath(proxyContext != null ? proxyContext + "/api/am/admin/" : "/api/am/admin/");
            cookie.setHttpOnly(true);
            cookie.setSecure(true);
            cookie.setMaxAge((int) expiresIn);
            response.addCookie(cookie);
            ...
            cookie = new Cookie("admin_session_state", request.getParameter("session_state"));
            cookie.setPath(context + "/");
            cookie.setSecure(true);
            cookie.setMaxAge(-1);
            response.addCookie(cookie);
