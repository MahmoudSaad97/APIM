 ...
 * Generated at: 2024-07-09 09:56:04 UTC
...
public final class retention_005fajaxprocessor_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("org.wso2.carbon.registry.properties.stub.beans.xsd.RetentionBean");
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        // /properties/retention_ajaxprocessor.jsp(32,0) name = resourceBundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_carbon_005fjsi18n_005f0.setResourceBundle("org.wso2.carbon.registry.properties.ui.i18n.JSResources");
        // /properties/retention_ajaxprocessor.jsp(32,0) name = request type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_carbon_005fjsi18n_005f0.setRequest(request);
        // /properties/retention_ajaxprocessor.jsp(32,0) name = namespace type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_carbon_005fjsi18n_005f0.setNamespace("org.wso2.carbon.registry.properties.ui");
 ...
 if(!readOnly) {
      ...
      out.write("    function initDatePickers() {\n");
      out.write("        jQuery(\"#fromDate\").datepicker();\n");
      out.write("        jQuery(\"#toDate\").datepicker();\n");
      out.write("    }\n");
      out.write("    jQuery(document).ready(initDatePickers);\n");
      out.write("</script>\n");
      //  fmt:bundle
      ...
      try {
        ...
        // /properties/retention_ajaxprocessor.jsp(73,0) name = basename type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if (bean != null) { 
            ...
            out.write("    	</table>\n");
            out.write("    </div>\n");
            out.write("    <div class=\"box1-mid-fill\" id=\"retentionMinimized\" ");
 if (bean != null) { 
            out.write(" style=\"display:none;\" ");
 } 
            out.write("></div>\n");
            out.write("    <!--div class=\"box1-mid-fill\" id=\"searchMinimized\" style=\"display:none\"></div-->\n");
            out.write("    <div class=\"box1-mid\" id=\"retentionExpanded\" ");
 if (bean == null) { 
            ...
            out.write(">\n");
            out.write("    <!--div class=\"box1-mid\" id=\"searchExpanded\"-->\n");
            out.write("        <form action=\"\" method=\"put\" style=\"display:inline;\" name=\"retentionForm\">\n");
            out.write("            <input type=\"hidden\" id=\"resourcePathId\" name=\"resourcePath\" value=\"");
            out.print(path);
            out.write("\"/>\n");
            out.write("            <table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"width: 100%;\"\n");
            ...
            out.write("                <tr>\n");
            out.write("                    <td>\n");
            out.write("                        <table class=\"normal\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">\n");
            out.write("                            <tr>\n");
            out.write("                                <td>");
            ...
            out.write(" :</td>\n");
            out.write("                                <td>\n");
            out.write("                                    <a class=\"icon-link\" style=\"background-image: url( ../admin/images/calendar.gif);\"  onclick=\"jQuery('#fromDate').datepicker( 'show' );\" href=\"javascript:void(0)\"></a>\n");
            out.write("                                    <input type=\"text\" name=\"fromDate\"\n");
            out.write("                                           value=\"");
            out.print( (bean != null) ? bean.getFromDate() : "" );
            out.write("\"\n");
            out.write("                                           style=\"width:140px;\" id=\"fromDate\"\n");
            out.write("                                           />\n");
            out.write("                                </td>\n");
            out.write("                            </tr>\n");
            out.write("                            <tr>\n");
            ...
            out.write(" :</td>\n");
            out.write("                                <td>\n");
            out.write("                                    <a class=\"icon-link\" style=\"background-image: url( ../admin/images/calendar.gif);\" onclick=\"jQuery('#toDate').datepicker( 'show' );\" href=\"javascript:void(0)\"></a>\n");
            out.write("                                    <input type=\"text\" name=\"toDate\"\n");
            out.write("                                           value=\"");
            out.print( (bean != null) ? bean.getToDate() : "" );
            out.write("\"\n");
            out.write("                                           style=\"width:140px;\" id=\"toDate\"\n");
            out.write("                                           />\n");
            out.write("                                </td>\n");
            out.write("                            </tr>\n");
            out.write("                        </table>\n");
            ...
            out.write("<br/>\n");
            out.write("                                &nbsp;&nbsp;\n");
            out.write("                        <input type=\"checkbox\" name=\"write\" value=\"true\" id=\"writeBoxId\"\n");
            out.write("                               ");
            out.print((bean != null && bean.getWriteLocked()) ? "checked=\"true\"" : "");
            out.write("\n");
            out.write("                               />\n");
            out.write("                                ");
            ...
            out.write("<br/>\n");
            out.write("                                &nbsp;&nbsp;\n");
            out.write("                        <input type=\"checkbox\" name=\"delete\" value=\"true\" id=\"readBoxId\"\n");
            out.write("                               ");
            out.print((bean != null && bean.getDeleteLocked()) ? "checked=\"true\"" : "");
            out.write("\n");
            out.write("                               />\n");
            out.write("                                ");
            ...
            out.print(writeAllowed ? "":"disabled=\"disabled\"" );
            out.write(" id=\"#_0\" value=\"");
            if (_jspx_meth_fmt_005fmessage_005f6(_jspx_th_fmt_005fbundle_005f0, _jspx_page_context))
              return;
            out.write("\"\n");
            out.write("                               class=\"button\" onclick=\"setRetentionProperties()\"\n");
            out.write("                               ");
            out.print(readOnly ? "style=\"display:none\"" : "");
            out.write("/>\n");
            out.write("                        <input type=\"button\" ");
            out.print(writeAllowed ? "" : "disabled=\"disabled\""  );
            out.write(" id=\"#_1\" value=\"");
            if (_jspx_meth_fmt_005fmessage_005f7(_jspx_th_fmt_005fbundle_005f0, _jspx_page_context))
              return;
            out.write("\"\n");
            out.write("                               class=\"button\" onclick=\"resetRetentionProperties()\"\n");
            out.write("                               ");
            out.print(readOnly ? "style=\"display:none\"" : "");
            out.write("/>\n");
            out.write("                    </td>\n");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /properties/retention_ajaxprocessor.jsp(78,63) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f0.setKey("retention");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /properties/retention_ajaxprocessor.jsp(107,36) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /properties/retention_ajaxprocessor.jsp(117,36) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f2.setKey("to");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /properties/retention_ajaxprocessor.jsp(127,24) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f3.setKey("activities");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /properties/retention_ajaxprocessor.jsp(132,32) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f4.setKey("write");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /properties/retention_ajaxprocessor.jsp(137,32) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /properties/retention_ajaxprocessor.jsp(143,109) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f6.setKey("lock");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /properties/retention_ajaxprocessor.jsp(146,112) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
