 ...
 * Generated at: 2024-07-09 09:53:51 UTC
...
import org.wso2.carbon.registry.resource.ui.clients.CustomUIHandler;
import org.wso2.carbon.registry.resource.ui.Utils;
import org.wso2.carbon.registry.resource.stub.beans.xsd.ContentBean;

public final class content_005fajaxprocessor_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("org.wso2.carbon.registry.resource.stub.beans.xsd.ContentBean");
    _jspx_imports_classes.add("org.wso2.carbon.registry.resource.ui.clients.CustomUIHandler");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        // /resources/content_ajaxprocessor.jsp(53,0) name = basename type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(!cb.getAbsent().equals("true")){
            ...
            out.write("                    <h2 class=\"sub-headding-entries\">");
if (cb.getCollection()) { 
            out.write("\n");
            out.write("                        ");
            ...
            out.write("\n");
            out.write("                    <a onclick=\"javascript: showHideCommon('entriesIconExpanded');showHideCommon('entriesIconMinimized');showHideCommon('entriesExpanded');showHideCommon('entriesMinimized');\">\n");
            out.write("                        <img src=\"../resources/images/icon-expanded.gif\" border=\"0\" align=\"top\"\n");
            out.write("                             id=\"entriesIconExpanded\"/>\n");
            out.write("                        <img src=\"../resources/images/icon-minimized.gif\" border=\"0\" align=\"top\"\n");
            out.write("                             id=\"entriesIconMinimized\" style=\"display:none;\"/>\n");
            out.write("                    </a>\n");
            out.write("\n");
            out.write("\n");
            out.write("                </td>\n");
            ...
            out.write("        </table>\n");
            out.write("    </div>\n");
            out.write("    <div class=\"box1-mid-fill\" id=\"entriesMinimized\" style=\"display:none\"></div>\n");
            out.write("    <div class=\"box1-mid\" id=\"entriesExpanded\">\n");
 ...
 if (!cuiURL.contains("hideStandardView=true")) {
            ...
            out.write("\n");
            out.write("        <a onclick=\"viewStandardContentSectionWithNoEdit('");
            out.print(cb.getPathWithVersion());
            out.write("')\">");
            ...
            out.write("\n");
            out.write("        <a id=\"stdViewLink\" onclick=\"viewStandardContentSection('");
            out.print(cb.getPathWithVersion());
            out.write("')\">");
            ...
            out.write("\n");
            out.write("        <div id=\"customViewUIDiv\">\n");
            out.write("            ");
            org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, cuiURL, out, false);
            out.write("\n");
            out.write("        </div>\n");
            out.write("        ");
            ...
            out.write("\n");
            out.write("        <a id=\"custViewLink\" onclick=\"viewCustomContentSection('");
            out.print(cb.getPathWithVersion());
            out.write("')\">");
 ...
 if (cb.getPutAllowed() && !cb.getVersionView() && cb.getLoggedIn() && !cui) { 
            out.write("\n");
            out.write("        <div class=\"registryWriteOperation\" style=\"display:block;height:30px;\">\n");
            out.write("            <a class=\"add-resource-icon-link registryWriteOperation\"\n");
            out.write("               onclick=\"showHide('add-resource-div');resetResourceForms()\">");
            ...
            out.write("\n");
            out.write("        <div class=\"registryWriteOperation\" style=\"display:block;height:30px;\">\n");
            out.write("            <a class=\"add-collection-icon-link registryWriteOperation\"\n");
            out.write("               onclick=\"javascript: showHide('add-folder-div');expandIfNot('entries');if($('add-folder-div').style.display!='none')$('collectionName').focus();\">\n");
            out.write("                ");
 ...
 if (!isRemote & !isLink) { 
            out.write("\n");
            out.write("        <div class=\"registryWriteOperation\" style=\"display:block;height:30px;\">\n");
            out.write("            <a class=\"add-link-icon-link registryWriteOperation\"\n");
            out.write("               onclick=\"javascript: showHide('add-link-div');resetLinkForms()\">\n");
            out.write("                ");
            ...
            out.write("\n");
            out.write("        ");
            org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "raw-collection-content.jsp", out, false);
            out.write("\n");
            out.write("\n");
            out.write("        ");
 } else {
            ...
            out.write("\n");
            out.write("\n");
            out.write("        <table style=\"*width:430px !important;\">\n");
            out.write("        <tr>\n");
            out.write("        ");
 if (cb.getMediaType() != null) {
            ...
            out.write("\n");
            out.write("        <td>\n");
            out.write("        <a onclick=\"visualizeXML('");
            out.print(cb.getPathWithVersion());
            out.write("', '");
            out.print(type);
            out.write("')\"><img src=\"../resources/images/visualize.png\" alt=\"\" align=\"top\"> ");
            if (_jspx_meth_fmt_005fmessage_005f8(_jspx_th_fmt_005fbundle_005f0, _jspx_page_context))
              return;
            out.write("</a>\n");
            out.write("\n");
            out.write("        </td>\n");
            out.write("        <td style=\"vertical-align:middle;padding-left:5px;padding-right:5px;\">|</td>\n");
            out.write("        ");
            ...
            out.write("\n");
            out.write("        <td>\n");
            out.write("        <a onclick=\"displayContentAsText('");
            out.print(cb.getPathWithVersion());
            out.write("')\"><img src=\"../admin/images/view.gif\" alt=\"\" align=\"top\"> ");
 ...
 if (cb.getPutAllowed() && !cb.getVersionView() && !"true".equals(request.getParameter("hideEdit")) && !cb.getMediaType().equals("application/vnd.wso2.registry-ext-type+xml")) { 
            out.write("\n");
            out.write("        <td class=\"registryWriteOperation\" style=\"vertical-align:middle;padding-left:5px;padding-right:5px;\">|</td>\n");
            out.write("        <td>\n");
            out.write("        <a onclick=\"displayEditContentAsText('");
            out.print(cb.getPathWithVersion());
            out.write("')\" class=\"registryWriteOperation\"><img src=\"../admin/images/edit.gif\" alt=\"\" align=\"top\"> ");
 ...
 if (cb.getPutAllowed() && !cb.getVersionView() && !"true".equals(request.getParameter("hideEdit")) && !cb.getMediaType().equals("application/vnd.wso2.registry-ext-type+xml")) { 
            out.write("\n");
            out.write("        <td>\n");
            out.write("        <a onclick=\"displayUploadContent('");
            out.print(cb.getPathWithVersion());
            out.write("')\" class=\"registryWriteOperation\">\n");
            out.write("            <img src=\"../resources/images/icon-upload.jpg\" alt=\"\" align=\"top\"> ");
            ...
            out.write("\n");
            out.write("                <a class=\"icon-link\" style=\"background-image:url(../resources/images/icon-download.jpg);\"\n");
            out.write("		           href=\"");
            out.print(path);
            out.write("\"\n");
            ...
            out.write("\n");
            out.write("	    <a onclick=\"javascript:downloadWithDependencies('");
            out.print(Utils.getResourceDownloadURL(request, path));
            out.write('\'');
            out.write(',');
            out.print(String.valueOf(hasDependencies));
            out.write(")\"\n");
            out.write("		           class=\"registryWriteOperation\"><img src=\"../resources/images/icon-download.jpg\" alt=\"\" align=\"top\"> ");
            ...
            out.write("        <br/>\n");
            out.write("\n");
            out.write("        <div id=\"generalContentDiv\" style=\"display:none;\">\n");
            out.write("        </div>\n");
            out.write("        \n");
            out.write("        ");
 }
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /resources/content_ajaxprocessor.jsp(69,24) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f0.setKey("entries");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /resources/content_ajaxprocessor.jsp(70,24) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f1.setKey("content");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /resources/content_ajaxprocessor.jsp(93,90) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f2.setKey("standard.view");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /resources/content_ajaxprocessor.jsp(97,97) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f3.setKey("standard.view");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /resources/content_ajaxprocessor.jsp(109,96) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f4.setKey("custom.view");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /resources/content_ajaxprocessor.jsp(123,75) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f5.setKey("add.resource");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /resources/content_ajaxprocessor.jsp(131,16) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f6.setKey("add.collection");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /resources/content_ajaxprocessor.jsp(137,16) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f7.setKey("add.link");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /resources/content_ajaxprocessor.jsp(160,144) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f8.setKey("visualize");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f9(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /resources/content_ajaxprocessor.jsp(178,130) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f9.setKey("display.as.text");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f10(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /resources/content_ajaxprocessor.jsp(185,165) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f10.setKey("edit.as.text");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f11(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /resources/content_ajaxprocessor.jsp(194,79) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f11.setKey("upload");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f12(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /resources/content_ajaxprocessor.jsp(211,29) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f12.setKey("download");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f13(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /resources/content_ajaxprocessor.jsp(216,113) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f13.setKey("download");
