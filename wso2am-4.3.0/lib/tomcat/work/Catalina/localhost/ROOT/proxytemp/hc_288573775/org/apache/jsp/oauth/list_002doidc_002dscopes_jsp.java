 ...
 * Generated at: 2024-07-09 10:05:02 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.oauth;
...
import org.wso2.carbon.identity.oauth.ui.client.OAuthAdminClient;
import org.wso2.carbon.ui.CarbonUIMessage;
import org.wso2.carbon.ui.CarbonUIUtil;
import org.wso2.carbon.utils.ServerConstants;
import java.util.ResourceBundle;

public final class list_002doidc_002dscopes_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("org.wso2.carbon.identity.oauth.ui.client.OAuthAdminClient");
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        // /oauth/list-oidc-scopes.jsp(32,0) name = basename type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_fmt_005fbundle_005f0.setBasename("org.wso2.carbon.identity.oauth.ui.i18n.Resources");
        ...
        if (_jspx_eval_fmt_005fbundle_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            try {
              ...
              // /oauth/list-oidc-scopes.jsp(34,4) name = label type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_carbon_005fbreadcrumb_005f0.setLabel("list.scope");
              // /oauth/list-oidc-scopes.jsp(34,4) name = resourceBundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_carbon_005fbreadcrumb_005f0.setResourceBundle("org.wso2.carbon.identity.oauth.ui.i18n.Resources");
              // /oauth/list-oidc-scopes.jsp(34,4) name = topPage type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_carbon_005fbreadcrumb_005f0.setTopPage(true);
              // /oauth/list-oidc-scopes.jsp(34,4) name = request type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            out.write("\n");
            out.write("                function removeItem(sName) {\n");
            out.write("                    function doDelete() {\n");
            out.write("                        var scopeName = sName;\n");
            out.write("                        $.ajax({\n");
            out.write("                            type: 'POST',\n");
            out.write("                            url: 'remove-oidc-scope-finish-ajaxprocessor.jsp',\n");
            out.write("                            headers: {\n");
            out.write("                                Accept: \"text/html\"\n");
            out.write("                            },\n");
            out.write("                            data: 'scopeName=' + scopeName,\n");
            out.write("                            async: false,\n");
            out.write("                            success: function (responseText, status) {\n");
            out.write("                                if (status == \"success\") {\n");
            out.write("                                    location.assign(\"list-oidc-scopes.jsp\");\n");
            out.write("                                }\n");
            out.write("                            }\n");
            out.write("                        });\n");
            out.write("                    }\n");
            out.write("\n");
            out.write("                    CARBON.showConfirmationDialog('Are you sure you want to delete \"' + sName +\n");
            out.write("                        '\" scope information?',\n");
            ...
            out.write("                            title=\"Update OIDC Scope\"\n");
            out.write("                            href=\"edit-oidc-claims.jsp?scopeName=");
            out.print(Encode.forUriComponent(scope));
            out.write("\"\n");
            ...
            out.write("</a>\n");
            out.write("                        \n");
            out.write("                        <a title=\"Delete OIDC Scope\"\n");
            out.write("                           onclick=\"removeItem('");
            out.print(Encode.forJavaScriptAttribute(scope));
            out.write("');return\n");
            out.write("                                   false;\" href=\"#\"\n");
            out.write("                           class=\"icon-link\"\n");
            ...
            out.write("                        </a>\n");
            out.write("                        \n");
            out.write("                        <a title=\"Add OIDC Claims for Scope\"\n");
            out.write("                           href=\"add-oidc-claims.jsp?scopeName=");
            out.print(Encode.forUriComponent(scope));
            out.write("\"\n");
            out.write("                           class=\"icon-link\"\n");
            out.write("                           style=\"background-image: url(../admin/images/edit.gif)\">");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /oauth/list-oidc-scopes.jsp(38,12) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f0.setKey("title.list.scope");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /oauth/list-oidc-scopes.jsp(89,24) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f1.setKey("scope.name");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /oauth/list-oidc-scopes.jsp(91,43) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f2.setKey("scope.action");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /oauth/list-oidc-scopes.jsp(111,84) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f3.setKey("update");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /oauth/list-oidc-scopes.jsp(118,85) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /oauth/list-oidc-scopes.jsp(125,83) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f5.setKey("add.claims");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /oauth/list-oidc-scopes.jsp(140,39) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f6.setKey("no.scope.registered");
